...
namespace wuxingogo.BTNode
{
    public class BTNode : DragNode
    {
        ...
        public override void Draw()
        {
            ...
            GUI.Box( DrawBounds, "", XStyles.GetInstance().FindStyle( "GreyBox" ) );
            DrawChildNodes();

            if( Selected )
            {
                GUI.Box( DrawBounds, "", XStyles.GetInstance().FindStyle( "BlueBox" ) );
            }
            ...
            {
                Rect button = new Rect( new Vector2( DrawBounds.xMin, DrawBounds.center.y + 50 + i * 40 ), new Vector2( 100, 20 ) );
