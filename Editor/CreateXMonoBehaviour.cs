...
public class CreateXMonoBehaviour : XBaseEditor {
	...
	public static void CreateFile()
	{
		...
		string path = EditorUtility.SaveFilePanel("Create A XMonoBehaviour", AssetDatabase.GetAssetPath(sourceTex), "NewScript.cs", "cs");
		if (path == "")
			return;
...
//		Debug.Log("路径：" + file.DirectoryName);
		...
		sw.Write("using UnityEngine;\n"
		          + "using System.Collections;\n"
		         + "public class "+ className +" : XMonoBehaviour "
		        + "\n{"
		        + "\n}");//追加数据             
