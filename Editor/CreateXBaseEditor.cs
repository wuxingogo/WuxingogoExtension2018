...
public class CreateXBaseEditor : XBaseEditor 
{
	...
	public static void CreateFile()
	{
		...
		string path = EditorUtility.SaveFilePanel("Create A XBaseEditor", AssetDatabase.GetAssetPath(sourceTex), "NewEditor.cs", "cs");
		if (path == "")
			return;
...
//		Debug.Log("路径：" + file.DirectoryName);
		...
		sw.Write("using UnityEngine;\n"
		         + "using UnityEditor;\n"
		         + "using System.Collections;\n"
		         + "public class "+ className +" : XBaseEditor "
		         + "\n{"
		         + "\n}");//追加数据             
